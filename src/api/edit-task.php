...
add_action('rest_api_init', function () {
    register_rest_route( 'social/v2', 'edit-task', array(
  ...
  // CALLBACK FUNTION
  function edit_task(WP_REST_Request $request) { // works without WP_REST_Request
        ...
        if ($request_type == "POST") { 
            ...
            return array(
                ...
                "method"     => "POST", 
                "message"    => "ENDPOINT: social/v2/edit-task", 
